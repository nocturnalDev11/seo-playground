	...
	return (
		<>
			...
			<main className="max-w-3xl mx-auto px-4 py-10">
				<h1 className="text-3xl font-bold text-gray-900 mb-6 border-b pb-2 dark:text-white">SEO Blog Posts</h1>
				...
				<ul className="space-y-4">
					{blogPosts.map((post) => (
						<li key={post.slug}>
							<Link
								href={`/blog/${post.slug}`}
								className="block p-4 rounded-xl border hover:bg-gray-50 dark:hover:bg-gray-800 transition shadow-sm"
							>
